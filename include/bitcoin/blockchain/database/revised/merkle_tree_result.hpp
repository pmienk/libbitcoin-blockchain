 ...
 */
#ifndef LIBBITCOIN_MERKLE_TREE_RESULT_HPP
#define LIBBITCOIN_MERKLE_TREE_RESULT_HPP
...
class BCB_API merkle_tree_result
{
public:
    merkle_tree_result(simple_allocator::bytes_type data,
        uint64_t size_limit);
