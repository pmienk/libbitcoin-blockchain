...
#ifndef LIBBITCOIN_BLOCKCHAIN_TRIE_REVERSE_ITERATOR_HPP
#define LIBBITCOIN_BLOCKCHAIN_TRIE_REVERSE_ITERATOR_HPP
...
class trie_reverse_iterator : public reverse_iterator<Iterator>
{
public:
...
public:
    ...
    bool is_first_primary_key_value() const;

    bool is_last_primary_key_value() const;
};

} // namespace blockchain
} // namespace libbitcoin

#include <bitcoin/blockchain/impl/trie/trie_reverse_iterator.ipp>
