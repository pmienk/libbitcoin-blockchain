...
static std::vector<typename binary_trie<Value, std::allocator<trie_node<Value>>, std::allocator<value_list_node<Value>>>::pair_iterator_bool>
    insert_equal(
        binary_trie<Value, std::allocator<trie_node<Value>>, std::allocator<value_list_node<Value>>>& tree,
        std::vector<std::pair<Value, bc::binary_type>>& value_key_pairs)
{
    std::vector<typename binary_trie<Value, std::allocator<trie_node<Value>>, std::allocator<value_list_node<Value>>>::pair_iterator_bool> result;
...
static void test_insert_unique_matches_expectation(
    binary_trie<Value, std::allocator<trie_node<Value>>, std::allocator<value_list_node<Value>>>& tree,
    std::vector<std::tuple<bool, Value, bc::binary_type>>& query_tuples)
{
    // insert
...
static void verify_iterator_range(std::vector<Value>& expected,
    typename binary_trie<Value,
        std::allocator<trie_node<Value>>,
        std::allocator<value_list_node<Value>>>::iterator_range& range)
{
...
static void verify_iterator_range(
    std::vector<std::pair<Value, bc::binary_type>>& expected,
    typename binary_trie<Value,
        std::allocator<trie_node<Value>>,
        std::allocator<value_list_node<Value>>>::iterator_range& range)
{
...
{
    std::allocator<trie_node<int>> trie_allocator;
    std::allocator<value_list_node<int>> value_allocator;
    binary_trie<int, std::allocator<trie_node<int>>,
        std::allocator<value_list_node<int>>>* tree = new binary_trie<int,
            std::allocator<trie_node<int>>, std::allocator<value_list_node<int>>>(
                trie_allocator, value_allocator);
...
BOOST_AUTO_TEST_CASE(insert_equal_zero_length_key_fails)
{
    ...
    binary_trie<int, std::allocator<trie_node<int>>,
        std::allocator<value_list_node<int>>> tree(trie_allocator, value_allocator);

    bc::binary_type key(0, bc::data_chunk {});
    int value = 17;
...
BOOST_AUTO_TEST_CASE(insert_equal_nonzero_length_key_succeeds)
{
    ...
    bc::binary_type key(20, bc::data_chunk { 0xAA, 0xBB, 0xCC });
    int value = 17;
...
BOOST_AUTO_TEST_CASE(insert_equal_multiple_same_key_succeeds)
{
    ...
    for (; (rit != find_result.second) && (vit != values.rend()); ++rit, ++vit)
    {
        BOOST_REQUIRE(*vit == *rit);
    }

    BOOST_REQUIRE(vit == values.rend());
...
BOOST_AUTO_TEST_CASE(insert_equal_add_leaf_node)
{
    ...
    std::vector<std::pair<int, bc::binary_type>> value_key_pairs = {
        std::make_pair(97,      bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(112,     bc::binary_type(20, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(17,      bc::binary_type(25, bc::data_chunk { 0xAA, 0xBB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(insert_equal_match_existing_intermediary_node)
{
    ...
    std::vector<std::pair<int, bc::binary_type>> value_key_pairs = {
        std::make_pair(97,      bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(112,     bc::binary_type(20, bc::data_chunk { 0xAA, 0xBB, 0x00 })),
        std::make_pair(17,      bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(26,      bc::binary_type(16, bc::data_chunk { 0xAA, 0xBB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(insert_equal_multiple_unique_keys)
{
    ...
    std::vector<std::pair<int, bc::binary_type>> value_key_pairs = {
        ...
        std::make_pair(17,      bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(26,      bc::binary_type(16, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(34,      bc::binary_type(22, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(56,      bc::binary_type(20, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(435,     bc::binary_type(15, bc::data_chunk { 0x0A, 0x5B, 0x00 })),
        std::make_pair(234,     bc::binary_type(18, bc::data_chunk { 0x00, 0x02, 0x00 }))
    };
...
BOOST_AUTO_TEST_CASE(insert_unique_collision_returns_error)
{
    ...
    std::vector<std::tuple<bool, int, bc::binary_type>> value_key_tuples = {
        std::make_tuple(true, 97,   bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_tuple(false, 112,  bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(insert_unique_add_leaf_node)
{
    ...
    std::vector<std::tuple<bool, int, bc::binary_type>> value_key_tuples = {
        std::make_tuple(true, 97,   bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_tuple(true, 112,  bc::binary_type(20, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_tuple(true, 17,   bc::binary_type(25, bc::data_chunk { 0xAA, 0xBB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(insert_unique_match_existing_intermediary_node)
{
    ...
    std::vector<std::tuple<bool, int, bc::binary_type>> value_key_tuples = {
        std::make_tuple(true, 97,   bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_tuple(true, 112,  bc::binary_type(20, bc::data_chunk { 0xAA, 0xBB, 0x00 })),
        std::make_tuple(true, 17,   bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_tuple(true, 26,   bc::binary_type(16, bc::data_chunk { 0xAA, 0xBB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(find_prefix_matches_none)
{
    ...
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(97,  bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(112, bc::binary_type(20, bc::data_chunk { 0xAA, 0xBB, 0x00 })),
        std::make_pair(17,  bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xBB, 0xCC }))
    ...
    bc::binary_type query(8, bc::data_chunk { 0xBB });
...
BOOST_AUTO_TEST_CASE(find_prefix_matches_all)
{
    ...
    bc::binary_type query(8, bc::data_chunk { 0xAA });
...
BOOST_AUTO_TEST_CASE(find_prefix_matches_returns_subset)
{
    ...
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(97,  bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(112, bc::binary_type(20, bc::data_chunk { 0xAA, 0xCB, 0x00 })),
        std::make_pair(17,  bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB, 0xCC }))
    };

    bc::binary_type query(10, bc::data_chunk { 0xAA, 0xC0 });
...
{
    bc::binary_type query(0, bc::data_chunk { 0x00 });

    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(17,  bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB, 0xCC }))
    };
...
{
    bc::binary_type query(4, bc::data_chunk { 0xFF });
...
BOOST_AUTO_TEST_CASE(remove_equal_from_leaf_of_root_with_single_value)
{
    ...
    std::vector<std::pair<int, bc::binary_type>> expected(
...
{
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(17,  bc::binary_type(10, bc::data_chunk { 0xAB, 0xA0 })),
        std::make_pair(523,  bc::binary_type(10, bc::data_chunk { 0xAB, 0xA0 })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(remove_equal_from_unique_key)
{
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(112, bc::binary_type(20, bc::data_chunk { 0xAA, 0xCB, 0x00 })),
        std::make_pair(235, bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(97,  bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(17,  bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB }))
    };
...
{
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(235, bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB })),
        std::make_pair(97,  bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB })),
        std::make_pair(112, bc::binary_type(20, bc::data_chunk { 0xAA, 0xCB, 0x00 })),
        std::make_pair(17,  bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB }))
    };
...
BOOST_AUTO_TEST_CASE(remove_prefix_from_empty_tree)
{
    ...
    bc::binary_type prefix(20, bc::data_chunk { 0xAA, 0xBB, 0xCC });
...
{
    bc::binary_type query(2, bc::data_chunk { 0x40 });
...
BOOST_AUTO_TEST_CASE(remove_prefix_from_single_node_matching_key_with_multiplicity)
{
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(17,  bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(22,  bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(57,  bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(remove_prefix_from_subtree_matching_key)
{
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(17,  bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(11,  bc::binary_type(16, bc::data_chunk { 0x55, 0x12 })),
        std::make_pair(99,  bc::binary_type(20, bc::data_chunk { 0x55, 0x12, 0xF0 })),
        std::make_pair(88,  bc::binary_type(20, bc::data_chunk { 0x55, 0x12, 0x00 })),
        std::make_pair(77,  bc::binary_type(14, bc::data_chunk { 0x50, 0xF0 })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB, 0xCC }))
    };
...
BOOST_AUTO_TEST_CASE(remove_prefix_from_subtree_matching_prefix)
{
    ...
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(00,  bc::binary_type(1, bc::data_chunk { 0x00 })),
        std::make_pair(17,  bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(11,  bc::binary_type(16, bc::data_chunk { 0x55, 0x12 })),
        std::make_pair(99,  bc::binary_type(20, bc::data_chunk { 0x55, 0x12, 0xF0 })),
        std::make_pair(88,  bc::binary_type(20, bc::data_chunk { 0x55, 0x12, 0x00 })),
...
BOOST_AUTO_TEST_CASE(remove_prefix_from_subtree_matching_key_with_multiplicity)
{
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        ...
        std::make_pair(57,  bc::binary_type(4, bc::data_chunk { 0x50 })),
        std::make_pair(11,  bc::binary_type(16, bc::data_chunk { 0x55, 0x12 })),
        std::make_pair(27,  bc::binary_type(16, bc::data_chunk { 0x55, 0x12 })),
        std::make_pair(99,  bc::binary_type(20, bc::data_chunk { 0x55, 0x12, 0xF0 })),
        std::make_pair(88,  bc::binary_type(20, bc::data_chunk { 0x55, 0x12, 0x00 })),
        std::make_pair(77,  bc::binary_type(14, bc::data_chunk { 0x50, 0xF0 })),
        std::make_pair(66,  bc::binary_type(14, bc::data_chunk { 0x50, 0xF0 })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB })),
        std::make_pair(56,  bc::binary_type(24, bc::data_chunk { 0xAA, 0xCB, 0xCC })),
        std::make_pair(44,  bc::binary_type(24, bc::data_chunk { 0xAA, 0xCB, 0xCF }))
    };
...
{
    std::vector<std::pair<int, bc::binary_type>> value_key_tuples = {
        std::make_pair(235, bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(97,  bc::binary_type(10, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(112, bc::binary_type(20, bc::data_chunk { 0xAA, 0xCB, 0x00 })),
        std::make_pair(17,  bc::binary_type(24, bc::data_chunk { 0xAA, 0xBB, 0xCC })),
        std::make_pair(26,  bc::binary_type(16, bc::data_chunk { 0xAA, 0xCB, 0xCC }))
